    ...
    <nav className="w-full flex py-6 justify-between items-center bg-gradient-to-r from-green-200 to-green-400 text-black">
      ...
      <ul className="list-none sm:flex hidden justify-end items-center flex-1">
        {navLinks.map((nav, index) => (
          <li
            key={nav.id}
            className={`font-poppins font-normal cursor-pointer text-[16px] transition-all duration-300 ease-in-out hover:bg-gradient-to-r hover:from-teal-500 hover:to-teal-600 hover:text-white hover:transform hover:translateY-[-3px] hover:scale-105 hover:shadow-lg hover:border-2 hover:border-green-800 rounded-lg px-4 py-2 ${
